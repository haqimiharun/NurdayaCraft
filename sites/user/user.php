...
<main class="d-flex flex-nowrap">
  ...
  <div class="container pt-5">
    ...
    <div class="row">
      ...
      <div class="col-md-2">
        <div class="row ">
          <button type="" class="btn justify-content-right" id="addBtn" name="addBtn">Add New User</button>
        </div>
      </div>
    </div>
    <div class="row">
    <table id="datagrid" class="display" title="News List">
      ...
      <tbody>
        <?php
        $query4 = "SELECT a.user_id, a.user_name, a.user_email, b.user_type_name, CASE WHEN a.user_status='Y' THEN 'ACTIVE' ELSE 'INACTIVE' END AS 'user_status' FROM user a, user_type b WHERE a.user_type_id=b.user_type_id AND a.user_status!='D'";
                	...
                	<form action="bgprocess.php" name="addForm" id="addForm" method="post" class="needs-validation" enctype="multipart/form-data" novalidate autocomplete="off">
                      ...
                      <div class="container">
                        <div class="row">
                          ...
                          <div class="col"><input type="text" class="input form-control" name="user_name" id="user_name" required></div>
                        </div>
                        <div class="row">
                          <div class="col">Email</div>
                          <div class="col"><input type="email" class="input form-control" name="user_email" id="user_email" required></div>
                        </div>
                        <div class="row">
                          <div class="col">Password</div>
                          <div class="col"><input type="password" class="input form-control" name="user_password1" id="user_password1" required></div>
                        </div>
                        <div class="row">
                          <div class="col">Re-Type Password</div>
                          <div class="col"><input type="password" class="input form-control" name="user_password" id="user_password" required></div>
                        </div>
                      </div>
                    </form>
                </div>
                ...
                <div class="modal-body">
                	<form action="bgprocess.php" name="editForm" id="editForm" method="post" class="edit-needs-validation" enctype="multipart/form-data" novalidate autocomplete="off">
                      ...
                      <div class="container">
                        <div class="row">
                          <div class="col">User Name</div>
                          <div class="col"><input type="text" class="input form-control" name="edit_user_name" id="edit_user_name" required></div>
                        </div>
                        <div class="row">
                          <div class="col">Email</div>
                          <div class="col"><input type="email" class="input form-control" name="edit_user_email" id="edit_user_email" required></div>
                        </div>
                        <div class="row">
                          <div class="col">Password</div>
                          <div class="col"><input type="password" class="input form-control" name="edit_user_password1" id="edit_user_password1"></div>
                        </div>
                        <div class="row">
                          <div class="col">Re-Type Password</div>
                          <div class="col"><input type="password" class="input form-control" name="edit_user_password" id="edit_user_password"></div>
                        </div>
                        <div class="row">
                          <div class="col">User Type</div>
                          <div class="col"><input type="text" class="input form-control" name="edit_user_type" id="edit_user_type" disabled></div>
                        </div>
                        <div class="row">
                          <div class="col">Status</div>
                          <div class="col">
                          <div class="form-check">
                            <input class="form-check-input" type="radio" name="edit_user_status" id="edit_flexRadioDefault1" value="Y">
                            <label class="form-check-label" for="edit_flexRadioDefault1">
                              Active
                            </label>
                          </div>
                          <div class="form-check">
                            <input class="form-check-input" type="radio" name="edit_user_status" id="edit_flexRadioDefault2" value="N">
                  ...
                  <button type="button" class="btn btn-danger" id="deleteUser"  data-toggle="confirmation">Delete</button>
            			<button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
          			</div>
            </div>
        </div>
